...
<a id="1">[Duan *et al.*, 2025]</a> 
Lin Duan, Elias Rotondo, Yanming Xiu, Sangjun Eom, Ryan Chen, Conrad Li, Yuhe Hu, and Maria Gorlatova. Probing the augmented reality scene analysis capabilities of large multimodal models: Toward reliable real-time assessment solutions. _IEEE Internet Computing,_ 2025.
